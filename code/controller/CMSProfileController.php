...
class CMSProfileController extends \CMSProfileController
{
    ...
    public function getEditForm($id = null, $fields = null)
    {
        ...
        if(extensions\TwoFactorAuthMemberExtension::validated_activation_mode()){
    ...
    public function load_token_data($request)
    {
        ...
        if(extensions\TwoFactorAuthMemberExtension::validated_activation_mode() && !$member->Has2FA){
            // set new secret/token on member
            $member->generateTOTPToken();
            $member->write();
        }
    ...
    public function handleRequest(SS_HTTPRequest $request, DataModel $model = null)
    {
        ...
        $response->addHeader('X-Controller', \Convert::raw2htmlname(str_replace('\\', '-', $this->class)));
